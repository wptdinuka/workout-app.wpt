  ...
  <div class="max-w-screen-sm mx-auto px-4 py-10">
    ...
    <div v-if="dataLoaded">
      ...
      >
        ...
        <span
          class="mt-6 py-1.5 px-5 text-xs text-white bg-at-light-blue
      ...
      >
        ...
        <div v-if="data.workoutType === 'strength'" class="flex flex-col gap-y-4 w-full">
          ...
          <button
            ...
            bg-at-light-blue duration-200 border-solid border-2 border-transparent
            hover:border-at-light-blue hover:bg-white hover:text-at-light-blue"
          >
            Add Exercise
          </button>
        </div>
          ...
          >
            <div class="flex flex-2 flex-col md:w-1/3">
              ...
              >
                ...
                <option value="heavy-bag-workout">Heavy-Bag-Workout</option>
